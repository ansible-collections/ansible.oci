...
DOCUMENTATION = r"""
---
module: oci_network_route_table_info
...
- name: List all route tables in a compartment
  ansible.oci.oci_network_route_table_info:
...
class OciNetworkRouteTableInfoModule(OciInfoBase):
...
def main():
    ...
    OciNetworkRouteTableInfoModule(module).execute_info_module()
