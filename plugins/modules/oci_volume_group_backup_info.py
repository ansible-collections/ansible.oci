...
short_description: Retrieve volume group backup information from Oracle Cloud Infrastructure
description:
  - Retrieve details about one or more OCI Block Volume group backups.
  - Use C(volume_group_backup_id) to fetch a single backup, or C(compartment_id)
...
class OciVolumeGroupBackupInfoModule(OciInfoBase):
    """Concrete info adapter for OCI volume group backups."""
