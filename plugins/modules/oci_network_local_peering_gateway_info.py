...
DOCUMENTATION = r"""
---
module: oci_network_local_peering_gateway_info
...
- name: List all local peering gateways in a compartment
  ansible.oci.oci_network_local_peering_gateway_info:
...
class OciNetworkLocalPeeringGatewayInfoModule(OciInfoBase):
...
def main():
    ...
    OciNetworkLocalPeeringGatewayInfoModule(module).execute_info_module()
