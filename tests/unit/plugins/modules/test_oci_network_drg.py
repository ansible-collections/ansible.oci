...
def test_main_exposes_allow_duplicate_name_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_drg")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkDrgModule", FakeDrgModule)
...
def test_build_create_drg_details_includes_supported_fields(monkeypatch):
    ...
    drg_module = load_collection_module("oci_network_drg")
