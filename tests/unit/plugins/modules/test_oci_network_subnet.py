...
def test_main_exposes_allow_duplicate_name_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_subnet")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkSubnetModule", FakeSubnetModule)
...
def test_build_create_subnet_details_includes_supported_fields(monkeypatch):
    ...
    subnet_module = load_collection_module("oci_network_subnet")
