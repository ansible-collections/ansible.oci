...
def test_main_exposes_route_rules_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_route_table")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkRouteTableModule", FakeRouteTableModule)
...
def test_build_create_route_table_details_includes_supported_fields(monkeypatch):
    ...
    route_table_module = load_collection_module("oci_network_route_table")
