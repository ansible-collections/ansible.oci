...
def test_main_exposes_peer_id_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_local_peering_gateway")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciLocalPeeringGatewayModule", FakeLpgModule)
...
def test_build_create_local_peering_gateway_details_includes_supported_fields(monkeypatch):
    ...
    lpg_module = load_collection_module("oci_local_peering_gateway")
