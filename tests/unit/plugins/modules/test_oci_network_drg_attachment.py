...
def test_main_exposes_expected_arguments(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_drg_attachment")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkDrgAttachmentModule", FakeDrgAttachmentModule)
...
def test_build_create_drg_attachment_details_excludes_compartment_id(monkeypatch):
    ...
    drg_attachment_module = load_collection_module("oci_network_drg_attachment")
...
def test_resolve_resource_by_name_ignores_stale_detached_duplicate(monkeypatch):
    ...
    # ambiguous name match instead of resolving the single live attachment.
