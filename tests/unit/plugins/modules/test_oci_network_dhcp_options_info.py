...
def make_dhcp_options_info_module(module_obj, params, client=None):
    return make_module_instance(
        module_obj,
        "OciNetworkDhcpOptionsInfoModule",
        params,
        client=client,
    )
...
def test_resource_id_kwarg_is_dhcp_id(monkeypatch):
    ...
    info_module = load_collection_module("oci_network_dhcp_options_info")

    assert info_module.OciNetworkDhcpOptionsInfoModule.resource_id_param == "dhcp_options_id"
    assert info_module.OciNetworkDhcpOptionsInfoModule.resource_id_kwarg == "dhcp_id"
