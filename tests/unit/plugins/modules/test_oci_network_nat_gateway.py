...
def test_main_exposes_allow_duplicate_name_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_nat_gateway")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkNatGatewayModule", FakeNatGatewayModule)
...
def test_build_create_nat_gateway_details_includes_supported_fields(monkeypatch):
    ...
    nat_gateway_module = load_collection_module("oci_network_nat_gateway")
