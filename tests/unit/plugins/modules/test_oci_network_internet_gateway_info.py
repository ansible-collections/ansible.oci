...
def make_internet_gateway_info_module(module_obj, params, client=None):
    return make_module_instance(
        module_obj,
        "OciNetworkInternetGatewayInfoModule",
        params,
        client=client,
    )
...
def test_main_requires_compartment_id_or_internet_gateway_id(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_internet_gateway_info")
    captured = {}
    ...
    monkeypatch.setattr(
        module_obj, "OciNetworkInternetGatewayInfoModule", FakeInternetGatewayInfoModule
    )
...
def test_resource_id_kwarg_is_ig_id_not_internet_gateway_id(monkeypatch):
    ...
    info_module = load_collection_module("oci_network_internet_gateway_info")

    assert info_module.OciNetworkInternetGatewayInfoModule.resource_id_param == (
        "internet_gateway_id"
    )
    assert info_module.OciNetworkInternetGatewayInfoModule.resource_id_kwarg == "ig_id"
