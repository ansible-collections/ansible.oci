...
def make_service_gateway_module(module_obj, params, client=None):
    return make_module_instance(
        module_obj,
        "OciNetworkServiceGatewayModule",
        params,
        client=client,
    )
...
def test_main_exposes_allow_duplicate_name_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_service_gateway")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkServiceGatewayModule", FakeServiceGatewayModule)
...
def test_build_service_models_wraps_each_id(monkeypatch):
    ...
    service_gateway_module = load_collection_module("oci_network_service_gateway")
