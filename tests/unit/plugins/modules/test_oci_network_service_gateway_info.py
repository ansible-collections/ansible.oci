...
def make_service_gateway_info_module(module_obj, params, client=None):
    return make_module_instance(
        module_obj,
        "OciNetworkServiceGatewayInfoModule",
        params,
        client=client,
    )
...
def test_main_requires_compartment_id_or_service_gateway_id(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_service_gateway_info")
    captured = {}
    ...
    monkeypatch.setattr(
        module_obj, "OciNetworkServiceGatewayInfoModule", FakeServiceGatewayInfoModule
    )
...
def test_fetch_resources_uses_list_filters(monkeypatch):
    ...
    info_module = load_collection_module("oci_network_service_gateway_info")
    paginate_calls = []
