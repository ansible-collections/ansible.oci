...
def test_main_exposes_allow_duplicate_name_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_dhcp_options")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkDhcpOptionsModule", FakeDhcpOptionsModule)
...
def test_build_create_dhcp_options_details_builds_both_option_types(monkeypatch):
    ...
    dhcp_options_module = load_collection_module("oci_network_dhcp_options")
