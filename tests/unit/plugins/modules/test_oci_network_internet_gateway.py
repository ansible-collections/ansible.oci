...
def make_internet_gateway_module(module_obj, params, client=None):
    return make_module_instance(
        module_obj,
        "OciNetworkInternetGatewayModule",
        params,
        client=client,
    )
...
def test_main_exposes_allow_duplicate_name_argument(monkeypatch):
    ...
    module_obj = load_collection_module("oci_network_internet_gateway")
    captured = {}
    ...
    monkeypatch.setattr(module_obj, "OciNetworkInternetGatewayModule", FakeInternetGatewayModule)
...
def test_build_create_internet_gateway_details_includes_supported_fields(monkeypatch):
    ...
    ig_module = load_collection_module("oci_network_internet_gateway")
